...
//# call-api state.list_resource ["0xb5d577dc9ce59725e29886632e69ecdf"]
...
//# call-api state.get_resource ["0xb5d577dc9ce59725e29886632e69ecdf","0x00000000000000000000000000000001::Account::Balance<0x00000000000000000000000000000001::STC::STC>"]



//// 0xb5d577dc9ce59725e29886632e69ecdf

////# run --signers bob --args {{$.call[0]}}
//script{
//    use StarcoinFramework::Debug;
//
//    /// faucet address generated from a hash of the faucet name
//    fun print_faucet(_sender: signer, access_path: vector<u8>){
