...
module StarcoinFramework::Secp256k1 {
    ...
    fun test_ecdsa_recover() {
        ...
        assert!(Option::is_some(&pk), 1);
        assert!(
            *&Option::extract(
                &mut pk
            ).bytes == x"4646ae5047316b4230d0086c8acec687f00b1cd9d1dc634f6cb358ac0a9a8ffffe77b4dd0a4bfb95851f3b7355c781dd60f8418fc8a65d14907aff47c903a559",
            1
        );
