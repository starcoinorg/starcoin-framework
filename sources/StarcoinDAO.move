module StarcoinFramework::StarcoinDAO{
    ...
    public (friend) fun create_dao(
        ...
        DAOSpace::install_plugin_with_root_cap<StarcoinDAO, InstallPluginProposalPlugin>(&dao_root_cap, 1, InstallPluginProposalPlugin::required_caps()); 
        DAOSpace::install_plugin_with_root_cap<StarcoinDAO, UpgradeModulePlugin>(&dao_root_cap, 1, UpgradeModulePlugin::required_caps());
        DAOSpace::install_plugin_with_root_cap<StarcoinDAO, ConfigProposalPlugin>(&dao_root_cap, 1, ConfigProposalPlugin::required_caps());
        DAOSpace::install_plugin_with_root_cap<StarcoinDAO, StakeToSBTPlugin>(&dao_root_cap, 1, StakeToSBTPlugin::required_caps());
