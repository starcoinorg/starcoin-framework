...
module StdlibUpgradeScripts {
    ...
    public entry fun upgrade_from_v11_to_v12(sender: signer, dag_height: u64) {
        do_upgrade_from_v11_to_v12(&sender, dag_height);
    }

    public fun do_upgrade_from_v11_to_v12(sender: &signer, dag_height: u64) {
        CoreAddresses::assert_genesis_address(sender);
        ...
        FlexiDagConfig::initialize(sender, dag_height);
