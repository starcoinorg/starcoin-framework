...
module StarcoinFramework::StdlibUpgradeScripts {
    ...
    public entry fun upgrade_from_v2_to_v3(_account: signer, _total_stc_amount: u128) {
    ...
    public entry fun take_linear_withdraw_capability(_signer: signer) {
    ...
    public fun do_upgrade_from_v5_to_v6(_sender: &signer) {
    ...
    public entry fun upgrade_from_v5_to_v6(_sender: signer) {
        //Self::do_upgrade_from_v5_to_v6(&sender)
        abort Errors::invalid_state(ERR_DEPRECATED)
    }

    public entry fun upgrade_from_v6_to_v7(_sender: signer) {
    ...
    public fun do_upgrade_from_v6_to_v7(_sender: &signer) {
        // do_upgrade_from_v6_to_v7_with_language_version(sender, 2);
        abort Errors::invalid_state(ERR_DEPRECATED)
    }

    public fun do_upgrade_from_v6_to_v7_with_language_version(_sender: &signer, _language_version: u64) {
    ...
    public entry fun upgrade_from_v7_to_v8(_sender: signer) {
        // do_upgrade_from_v7_to_v8(&sender);
        abort Errors::invalid_state(ERR_DEPRECATED)
    }

    public fun do_upgrade_from_v7_to_v8(_sender: &signer) {
        // {
